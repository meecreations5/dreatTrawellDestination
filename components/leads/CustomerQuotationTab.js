...
export default function CustomerQuotationTab({
  ...
  const requiresCost =
    pricingMode === "vendor_quote" || pricingMode === "manual_cost";

  const canCreateQuotation =
    sellingPrice > 0 &&
    (
      pricingMode === "direct" ||
      (requiresCost && hasCost && grossProfit >= 0)
    );
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Create direct quote, use any vendor pricing, or use manual costing.
              Vendor finalization is optional.
            </p>
          </div>
      ...
      <div className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          ...
          <SourceCard
            ...
            title="Use Vendor Pricing"
            description="Use any received vendor quote as cost base. Final selection is not required."
