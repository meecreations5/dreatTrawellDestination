...
function ToolbarButton({ icon: Icon, label, onClick }) {
  return (
    <button
      ...
      onClick={onClick}
      title={label}
      className="h-8 min-w-8 inline-flex items-center justify-center rounded-lg border border-gray-200 bg-white px-2 text-gray-600 hover:bg-gray-50 hover:text-gray-900"
    >
      ...
      <div className="w-full sm:max-w-3xl bg-white rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Use rich text formatting for requirement details. Travel agent name/code is not sent to vendor.
              </p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1.5">
              This HTML content will be saved and used for vendor email. Plain text is auto-generated for WhatsApp.
            </p>
          </div>
